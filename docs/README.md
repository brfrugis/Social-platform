...
| [**IMAGE_GENERATION.md**](./IMAGE_GENERATION.md) | **Studio images:** Ollama-supported models vs Qwen-Image-2512 (HF/diffusers), `OLLAMA_IMAGE_MODEL`, smoke test. |
